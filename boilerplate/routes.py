...
_routes = [
    ...
    RedirectRoute('/invite/', handlers.InviteUser, name='invite-user', strict_slash=True),
    RedirectRoute('/activation/<user_id>/<token>', handlers.AccountActivationHandler, name='account-activation', strict_slash=True),
    RedirectRoute('/invite/<user_id>/<token>', handlers.InviteActivationHandler, name='account-activation-invite', strict_slash=True),
